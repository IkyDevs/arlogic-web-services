...
interface TransactionActions {
  fetch: (dateFilter?: string, branchId?: string | null, monthFilter?: string, yearFilter?: string, customRange?: { start: string; end: string }) => Promise<void>
      ...
      set({
        transactions: [],
          analytics: {
            ...
            leadSourceCount: {}, leadSourceRevenue: {},
          },
        loading: false,
        error: null,
        lastFetched: null,
