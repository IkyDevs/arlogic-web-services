    ...
    <div className="bg-white rounded-xl border border-[#E9ECEF] shadow-sm overflow-hidden">
      <div className="p-4 border-b border-[#E9ECEF] flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-[#1A1A2E]">Daftar Service QC</h3>
          ...
          <div key={service.id} className="p-4 hover:bg-gray-50 transition-all">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <p className="font-medium text-[#1A1A2E]">{service.customer_name}</p>
                <div className="flex items-center gap-4 text-sm text-gray-500 mt-1 flex-wrap">
                  ...
                  {service.final_cost && (
                    <>
                      <span>•</span>
                      <span className="font-medium text-[#E94560]">{formatRupiah(service.final_cost)}</span>
                    </>
                  )}
                </div>
              </div>
              <button
                ...
                className="px-4 py-2 bg-[#1A1A2E] text-white text-sm font-medium rounded-lg hover:bg-[#0F3460] transition-all flex items-center gap-2"
              >
