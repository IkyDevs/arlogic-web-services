          ...
          >
                ...
                <div className="grid grid-cols-3 gap-2">
                  {RANGE_PRESETS.map((preset) => (
                    <button
                      ...
                      className="px-3 py-2.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg text-xs font-medium text-slate-700 transition-all active:scale-95"
                    >
                      {preset.label}
                    </button>
                  ))}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-900/10"
                      />
                    </div>
                  </div>
                  <div>
            ...
            <div className="px-6 py-4 border-t border-slate-200 bg-slate-50">
              <button
                ...
                className="w-full py-2.5 bg-slate-900 text-white font-semibold rounded-xl hover:bg-slate-700 transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Terapkan Filter
              </button>
            </div>
