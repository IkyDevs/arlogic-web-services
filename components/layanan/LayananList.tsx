            ...
            <tbody className="divide-y divide-slate-200">
              {filteredLayanan.map((item, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`badge ${getJenisLayananStyle(item.jenis_layanan)}`}
                    >
                      {jenisLayananLabels[item.jenis_layanan]}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-3">
                    ...
                    (item as any).photo_urls.length > 0 ? (
                      <button
                        ...
                        className="px-3 py-1.5 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-all text-xs font-medium"
                        title={`View ${(item as any).photo_urls.length} photos`}
                      >
                        <Eye className="w-4 h-4 inline mr-1" />
                        {(item as any).photo_urls.length} foto
                      </button>
