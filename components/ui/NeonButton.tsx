...
const variants = {
  ...
  danger:
    "bg-blue-500-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 shadow-red-500/20",
  warning:
    "bg-blue-500-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 shadow-orange-500/20",
};
