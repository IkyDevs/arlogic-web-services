...
export default function InventoryManagement({
  ...
  useEffect(() => {
    ...
    return () =>
      document.removeEventListener("openInventoryForm", handleOpenForm);
  }, []);
  ...
  const handleTransferPhotoSelect = (
        ...
        <div className="mb-4 sm:mb-5 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <button
              ...
              className="bg-slate-900 text-white font-medium px-4 py-2 rounded-lg hover:bg-slate-800 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
            >
          ...
          {showForm && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-2xl w-full max-w-sm md:max-w-md lg:max-w-lg max-h-[90vh] overflow-y-auto border border-slate-200 p-4 sm:p-6"
              >
                  ...
                  <div>
                    ...
                    {photoPreview ? (
                      ...
                      <div
                        ...
                        className="border-2 border-dashed border-slate-200 rounded-lg p-6 text-center cursor-pointer hover:border-slate-900 transition-all"
                      >
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <select
                        ...
                        className="flex-1 px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-slate-900 bg-white"
                      >
                    ...
                    <div className="mt-2 flex gap-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-slate-900 text-sm"
                        onKeyDown={async (e) => {
                          if (e.key === "Enter") {
                            e.preventDefault();
                      ...
                      <button
                        ...
                        className="px-3 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-all text-sm"
                      >
                        <Plus className="w-4 h-4" />
                      </button>
                    </div>
                  ...
                  >
                    ...
                    <div className="p-3">
                      <div className="flex justify-between items-start mb-1">
                        ...
                        <span className="text-[10px] bg-slate-100 px-1.5 py-0.5 rounded-full">
        ...
        {showTransferForm && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-white rounded-2xl shadow-2xl w-full max-w-sm md:max-w-md border border-slate-200 max-h-[85vh] overflow-y-auto"
            >
              ...
              <div className="p-4 space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setTransferQuantity(e.target.value.replace(/[^0-9]/g, ""))
                    }
                    className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-slate-900"
                    placeholder="0"
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-slate-900 text-sm resize-none"
